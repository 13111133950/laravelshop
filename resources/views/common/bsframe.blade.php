...
<link rel="stylesheet" href="{{asset('static/bootstrap/css/backstage.css')}}">
<link rel="stylesheet" href="{{asset('static/bootstrap/css/bootstrap.min.css')}}">
<link rel="stylesheet" href="{{asset('static/bootstrap/css/jquery-ui-1.10.4.custom.css')}}" />
<script type="text/javascript" charset="utf-8" src="{{asset('kindeditor/kindeditor.js')}}"></script>
<script type="text/javascript" charset="utf-8" src="{{asset('kindeditor/lang/zh_CN.js')}}"></script>
<script src="{{asset('static/jquery/jquery-1.10.2.js')}}"></script>
<script src="{{asset('static/jquery/jquery-ui-1.10.4.custom.js')}}"></script>
<script src="{{asset('static/jquery/jquery-ui-1.10.4.custom.min.js')}}"></script>
</head>

<body>
    <div class="head">
            <div class="logo fl"><a href="#"></a></div>
            <h3 class="head_text fr">阿飞淘宝网后台管理系统</h3>
    </div>
    @section('header')
                ...
                <ul class="mList">
                    <li>
                        ...
                        <dl id="menu1" style="display:none;">
                        	<dd><a href="{{url('admin/pro/create')}}" target="mainFrame">添加商品</a></dd>
                            <dd><a href="{{url('admin/pro')}}" target="mainFrame">商品列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu2','change2')" id="change2">+</span>分类管理</h3>
                        <dl id="menu2" style="display:none;">
                        	<dd><a href="{{url('admin/cate/create')}}" target="mainFrame">添加分类</a></dd>
                            <dd><a href="{{url('admin/cate')}}" target="mainFrame">分类列表</a></dd>
                        </dl>
                    </li>
                    <li>
...
<script type="text/javascript">
    ...
    function addCate(){
        window.location="{{url('admin/cate/create')}}";
        }
    function addPro(){
        window.location="{{url('admin/pro/create')}}";
        }
</script>
</body>
</html>